...
with st.sidebar:
    ZHIPUAI_API_KEY = st.text_input("GLM4 API Key", key="chatbot_api_key", type="password")
    "[获取GLM4 API](https://maas.aminer.cn/usercenter/apikeys)"
    "GLM是智谱全栈自研的AI新一代认知智能大模型，支持复杂的自然语言指令，具备解决困难问题的推理能力。"
    "GLM4作为全新升级的四代模型，更强大性能，更长的上下文、更高效的推理，整体性能相比三代模型提升60%"
    "新用户注册并实名后可享500万tokens免费体验。"
st.title("💬 你的推免助手")
st.caption("🚀 推免知识问答机器人")
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        {"role": "assistant", "content": "你好！我是推免助手问答机器人小T，请问您有什么问题吗？"}]
